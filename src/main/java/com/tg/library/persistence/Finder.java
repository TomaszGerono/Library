...
import com.tg.library.model.User;
...
//    
     ...
     * @throws SQLException
     */
    public List<AuthorDTO> queryForAuthors(String firstName, String middleName, String lastName, String title, String monastery) {
...
//        https://forums.oracle.com/ords/apexds/post/optional-parameter-in-preparedstatement-6657
        ...
        try (var conn = DriverManager.getConnection(Config.get_library_db_url())) {
            ...
            while (rs.next()) {
                ...
                var author = new AuthorDTO.Builder()
                        .firstName(rs.getString("first_name"))
                        .middleName(rs.getString("middle_name"))
                        .lastName(rs.getString("last_name"))
                        .title(rs.getString("title"))
                        .monastery(rs.getString("monastery"))
                        .build();
     ...
     * @throws SQLException
     */
    public static List<BookDTO> queryForBooks(String title, String alternateTitle, String genreID, String sectionID, String mainCharacter, String seriesID, String topicID) {
        ...
        try (var conn = DriverManager.getConnection(Config.get_library_db_url())) {
            ...
            while (rs.next()) {
                ...
                var book = new BookDTO.Builder()
                        ...
                        .mainCharacter(rs.getString("main_character"))
